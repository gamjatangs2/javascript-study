...
// A부터 B까지의 범위를 저장 -> 범위 안에 있는 숫자를 모두 더하는 함수 구현
...
console.log(`1부터 100까지의 합: ${sumAll(1, 200)}`);
console.log(`1부터 100까지의 합: ${sumAll(1, 10)}`);
...
const testArray = [52, 114, 46, 22, 1, 3];
