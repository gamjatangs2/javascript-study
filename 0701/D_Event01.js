...
//! 이벤트 핸들링
// 특정 이벤트에 반응하여 특정 동적을 실행하는 것을 의미
...
//? 2. DOM 프로퍼티ㅔ 할당: 자바스크립트에서 HTML 요소의 이벤트 핸들러 프로펓티에 함수를 할당하는 방법

//? 3. addEventListener 메서드: HTML 요소의 addEventListener 메서드를 사용하여 이벤트 핸들러 등록
// 표준 이벤트 모델, 한 요소에 여러 개의 이벤트 핸들러 등록 가능
// DOM 요소에 이벤트 리스너를 추가하는데 사용
// 첫 번째 매개변수로 이벤트 유형(click, load, input), 두 번째 매개변수로 이벤트 핸들러 함수를 받는다.
...
// 키보드 이벤트의 경우 어떤 키가 눌러졌는지에 대한 정보
