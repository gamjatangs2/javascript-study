...
// addEventListener 메서드를 사용하여 키보드 이벤트 핸들러를 등록

//! 마우스 이벤트

// click: 마우스 버튼을 클릭할 때 발생
// dblclik: 마우스 버튼을 빠르게 두 번 클릭할 때 발생
// mousemove: 마우스 버튼을 움직일 때 발생
// mousedown: 마우스 버튼을 누를 때 발생
// mouseup: 마우스 버튼을 떼면 발생

// addEventListener 메서드를 사용하여 마우스 이벤트 핸들러를 등록
...
// DOMContentLoaded: HTML문서가 완전히 로드되고 DOM 트리가 완성되었을 때 발생, 이미지나 스크립트 파일 등이 아직 로드가 되지 않아도 이벤트가 발생

// addEventListener 메서드를 사용하여 페이지 로드 이벤트 핸들러를 등록
