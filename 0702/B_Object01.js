...
// 속성(특성: 이름, 나이, 직업 등) & 메서드(동작: 걷다, 말하다, 먹다)로 구성

//! 2. 객체 생성

//? 2-1. 객체 리터럴
// 중괄호 {}를 이용해 생성
// 그 안에 키와 값이 클론(:)으로 구분되는 속성
...
// 함수를 사용해 객체를 생성하는 방법
// 코드를 재사용 하는 것이 용이
// new 키워드를 사용하여 객체를 새 객체로 생성, 반례적으로 함수명의 첫 글자는 대문자로 사용
...
let person1 = new Person("hyeri", 99, "Developer");
let person2 = new Person("hye", 97, "Doctor");
...
let person4 = new Person2("Baek Hye ri", 97, "Developer");
person4.greet();
