...
console.log(str.split(','));    // 문자열을 매개변수로 잘라서 배열을 만들어 리턴하는 기능

//! 2. Number

let num = 123.456;
console.log(num.toFixed(2));    // 소수점 아래 두 번째 자리까지 표시(반올림)
...
console.log(Math.random()); // 0과 1 사이의 숫자를 랜덤형식(무작위)
...
//? 프로토타입
// 그 객체를 기반으로 생성된 다른 객체들이 공통적으로 사용할 수 있는 속성과 메소드를 제공
